...
- Added \ subcommand with JSON/text hierarchy output based on metadata parent-child links.
- Added \ to emit resolved session plan (, wrapped , , injected env) without creating tmux sessions/artifacts.
- Added \ to discover active sessions across metadata-known project roots/sockets.
- Added \ stop condition with successful  exit path.
- Added red-first regression coverage for all four features in \.
...
- Verify \ shows expected nested hierarchy for parent/child sessions.
- Verify \ returns plan payload and does not create tmux session/meta artifacts.
- Verify \ includes active sessions across sibling project roots.
- Verify \ exits 0 with \.
- Verify regression + integration checks stay green: \?   	github.com/bma-d/lisa	[no test files]
ok  	github.com/bma-d/lisa/src	(cached) and \PASS: 3-level nested interactive Lisa smoke
L1=lisa-smoke-l1-20260220_093018_84582
L2=lisa-smoke-l2-20260220_093018_84582
L3=lisa-smoke-l3-20260220_093018_84582
Artifacts: /tmp/lisa-smoke-nested-20260220_093018_84582.
