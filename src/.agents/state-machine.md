...
13. **Done-file corruption handling**: malformed done sidecar payloads set `signals.doneFileReadError` and classification degrades to `done_file_read_error` when no stronger activity signal exists
